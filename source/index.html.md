...
close  |  true  |  number  |    收盘价,当K线为最晚的一根时，是最新成交价  |    
high  |  true  |  number  |    最高价  |     
low  |  true  |  number  |    最低价  |     
amount  |  true  |  number  |    成交量(币), 即 sum(每一笔成交量(张)*单张合约面值/该笔成交价)  |   
vol  |  true  |  number  |   成交量（张），买卖双边成交量之和  |     
count  |  true  |  number  |   成交笔数  |     
 \</tick\>    |               |    |      |           
...
amount  |  true  |  number  |  数量（张）  |   |    
direction  |  true  |  number  |  买卖方向  |   |    
